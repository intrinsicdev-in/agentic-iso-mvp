...
const master_document_list_1 = __importDefault(require("./routes/master-document-list"));
const document_analysis_1 = __importDefault(require("./routes/document-analysis"));
const document_relationships_1 = __importDefault(require("./routes/document-relationships"));
const duplicate_management_1 = __importDefault(require("./routes/duplicate-management"));
...
app.use('/api/master-document-list', master_document_list_1.default);
app.use('/api/document-analysis', document_analysis_1.default);
app.use('/api/document-relationships', document_relationships_1.default);
app.use('/api/duplicates', duplicate_management_1.default);

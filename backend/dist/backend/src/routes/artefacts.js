...
router.delete('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)([client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ACCOUNT_ADMIN]), async (req, res) => {
    try {
        const userId = req.user.id;
...
router.post('/:id/reviews', auth_1.authenticateToken, async (req, res) => {
    try {
...
router.get('/:id/reviews', auth_1.authenticateToken, async (req, res) => {
    try {

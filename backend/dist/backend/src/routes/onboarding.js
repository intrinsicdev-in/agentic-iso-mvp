...
router.post('/', async (req, res) => {
    try {
        const { companyName, industry, employeeCount, currentCertifications, targetStandards, currentProcesses, timeline, budget, primaryContact, additionalNotes } = req.body;
...
router.get('/checklist', async (req, res) => {
    try {
        ...
        const standardList = Array.isArray(standards) ? standards : [standards];
        const checklists = {
            'ISO_9001_2015': {

...
exports.seedISOClauses = seedISOClauses;
...
async function seedISOClauses() {
    ...
    for (const [clauseNumber, clauseData] of Object.entries(iso_standards_1.ISO_9001_2015_CLAUSES)) {
        // Create main clause
    ...
    for (const [clauseNumber, clauseData] of Object.entries(iso_standards_1.ISO_27001_2022_CLAUSES)) {
        // Create main clause
        const mainClause = await prisma.iSOClause.upsert({
            where: {
                standard_clauseNumber: {
...
//# sourceMappingURL=seed-iso-clauses.js.map
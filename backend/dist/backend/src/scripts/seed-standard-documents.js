...
const iso9001Documents = [
    {
        ...
        documentType: client_1.DocumentType.POLICY,
    ...
    },
    {
        ...
        documentType: client_1.DocumentType.PLAN,
        canBeFulfilledBy: ['Quality Manual', 'Quality & ISMS Manual'],
        fulfills: []
    },
    {
    ...
    },
    {
        ...
        clauseNumbers: ['9.2', '9.2.1', '9.2.2'],
        documentType: client_1.DocumentType.REPORT,
        canBeFulfilledBy: [],
        fulfills: []
    },
    {
    ...
    try {
        ...
        for (const doc of iso9001Documents) {
            await prisma.standardDocument.create({
                data: {
                    standard: client_1.StandardType.ISO_9001_2015,
                    documentType: doc.documentType || client_1.DocumentType.DOCUMENT,
...
//# sourceMappingURL=seed-standard-documents.js.map